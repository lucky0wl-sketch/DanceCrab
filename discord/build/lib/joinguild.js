...
exports.changeLeader = exports.fixOrder = void 0;
const client_1 = require("@prisma/client");
const prisma = new client_1.PrismaClient();
async function Gjoin(name, char_id) {
    try {
...
exports.fixOrder = fixOrder;
async function changeLeader(guild_id, char_id) {
    try {
