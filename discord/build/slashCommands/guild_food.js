...
const command = {
    command: new discord_js_1.SlashCommandBuilder()
        ...
        .addNumberOption(o => o.setName('food').setDescription('choose food').setRequired(true).addChoices({ name: 'Bakudandon', value: 1 }, { name: 'Pioneer Exciting Meal', value: 109 }, { name: 'Lucky Pancakes', value: 163 }, { name: 'Brother Grill', value: 253 }, { name: 'Fiery Tongs Feast Pot', value: 253 }, { name: 'Medicinal Prridge', value: 332 }, { name: 'Heaven & Earth Rice', value: 395 }, { name: 'Goddes gems Sweets', value: 422 }, { name: 'Shellfish Iso-Yaki', value: 455 }, { name: 'Holy Seafood Banquet', value: 500 }, { name: 'Motivated Noodles', value: 527 }, { name: "Hunter's Freaky Pot", value: 551 }, { name: 'Skewer Dumplings', value: 596 }, { name: 'Crimson BBQ Meat', value: 614 }, { name: 'Sweet Wrappings', value: 632 }, { name: 'Dawn Sky Toast', value: 650 }, { name: 'Five Colored Soup', value: 668 }, { name: 'Mori Mori Meat Pie', value: 708 }, { name: 'Blody Sala Salad', value: 704 }, { name: 'Fried Buns', value: 712 }))
        .addNumberOption(o => o.setName('duration').setDescription('choose duration').setRequired(true).addChoices({ name: '120 Hour', value: 1447942614 }, { name: '250 Hour', value: 1448411014 }))
    ...
    execute: async (interaction) => {
        ...
        if (course !== '01' && course !== '02' && course !== '03' && course !== '04')
            return;
