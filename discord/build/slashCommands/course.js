...
const command = {
    command: new discord_js_1.SlashCommandBuilder()
        ...
        .addStringOption(o => o.setName('course').setDescription('methode to for the task').setRequired(true).addChoices({ name: '01', value: '01' }, { name: '02', value: '02' }, { name: '03', value: '03' }, { name: '04', value: '04' }))
